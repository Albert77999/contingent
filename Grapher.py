...
class Graph:
    ...
    def remove_edge(self,input_task,consequecen_task):
        self._consequences_of[input_task].remove(consequecen_task)
        self._inputs_of[consequecen_task].remove(input_task)
